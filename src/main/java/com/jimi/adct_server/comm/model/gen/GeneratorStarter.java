package com.jimi.adct_server.comm.model.gen;
...
public class GeneratorStarter {
	...
	private static void genMssql() {
		PropKit.use("properties.ini");
		String url = PropKit.get("t_url2");
		String user = PropKit.get("t_user2");
		String password = PropKit.get("t_password2");
		// base model 所使用的包名
		...
		//设置Mapping名字
		generator.setMappingKitClassName("MssqlMappingKit");
